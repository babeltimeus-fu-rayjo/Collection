...
const cfg = initSettings('dnup', [
  ...
  { key: 'flashMs', label: 'Small banner duration', def: 1500, section: 'Bubbles & banners' },
  { key: 'flashBig', label: 'Big banner duration', def: 3500, section: 'Bubbles & banners', hint: 'The YOUR TURN banner.' },
